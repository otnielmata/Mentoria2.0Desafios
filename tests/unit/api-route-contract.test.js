...
const webContractRouteKeys = [
  ...
  "GET /desafios",
  "POST /desafios",
  "GET /desafios/inscricoes/minhas",
  "POST /desafios/:id/inscricoes",
  "GET /desafios/:id/questionario",
  "POST /desafios/:id/questionario/respostas",
  "POST /envios-desafios",
  "PATCH /envios-desafios/:id",
...
describe("api route contract MR-91", () => {
  ...
  it("documenta no Swagger as rotas reais consumidas pela Web", () => {
    ...
    [
      ...
      "/api/envios-desafios/{id}",
      "/api/desafios/inscricoes/minhas",
      "/api/desafios/:id/inscricoes",
      "/api/desafios/:id/questionario",
      "/api/desafios/:id/questionario/respostas",
      "/api/envios-desafios/aprovacoes",
      "/api/grupos/meus",
      "/api/grupos/:id/contato",
